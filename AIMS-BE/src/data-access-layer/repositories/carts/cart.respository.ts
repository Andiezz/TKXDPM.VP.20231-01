...
//     }
//     public async updateCartInfo(userId:string,productId: string, quantity: number) {
...
//         }
//         const cartId: string = cartIdObject.id.toString()
...
//             await this.cartProductDao.findProductsByCartId(cartId)

//         let quantitynew
//         if (!listCartProduct) {
//             quantitynew = quantity
//         } else {
//             for (const cartProduct of listCartProduct) {
//                 if (productId == product.id) {
//                     quantitynew = quantity + cartProduct.quantity
//                 }
//             }
//         }
